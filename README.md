[![Logo](/logo.png)](https://30secondsofcode.org/php/p/1)
...
* If you find a problem with a specific snippet, please [open an issue](https://github.com/30-seconds/30-seconds-of-php/issues/new).
